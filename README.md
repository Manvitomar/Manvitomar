<h1 align="center">Hi, I'm Manvi Tomar 👋</h1>
<p align="center">
  <b>Backend Developer</b> -  FastAPI -  C++ -  DSA Enthusiast
</p>
...
### ✍️ textUtils
A Django-based text analyzer for cleaning, transforming, and processing text efficiently.

### 🧮 calculator
A JavaScript project that demonstrates clean frontend logic and user interaction handling.

### 🌡️ temperatureConverter
A simple utility project built with web technologies for temperature conversion.

### 🎨 landingPge
A front-end practice project focused on layout and styling using CSS.

## 📈 Current Focus
- Building backend projects with FastAPI
- Strengthening problem-solving and DSA skills
- Writing cleaner, production-ready code
- Improving project structure and backend scalability
...
<p align="center">
  <i>Open to learning, collaboration, and backend development opportunities.</i>
</p>
